...
public class WyrmgardAdventure {
    ...
    Font hpAndWeapon = new Font ("Times New Roman", Font.PLAIN, 30);
    ...
    public WyrmgardAdventure(){
        ...
        titleCreditsLabel = new JLabel("\n\nTextadventure created by Lars Kastner");
    ...
    mainTextPanel.setBounds(10,10,400,600);
    mainTextPanel.setBackground(Color.black);
    con.add(mainTextPanel);
    
    mainTextArea = new JTextArea("");
    mainTextArea.setBounds(10,10,400,600);
    ...
    playerPanel.setBounds(450,10,300,100);
    ...
    public void townGate(){
        position = "townGate";
        mainTextArea.setText("Nach einer mehrtägigen Reise durch Wyrmgard, \nbist du an einem Dorf angekommen, welches den Namen \nKaltwacht trägt.\n Du fühlst dich hungrig und \ndeine Füße sind schwer wie Stein. \n\nDu stehst vor dem Torhaus des\nDorfes Kaltwacht.\nEine Wache steht vor dir.\n\n Was tust du?");
   ...
   public void holzFällerHütte(){
       ...
       mainTextArea.setText("Du folgst der schlammigen Straße und nach einiger Zeit kommst du an einer Hütte an. Der Kamin scheint befeuert worden zu sein, denn es steigt Rauch aus dem Schornstein.");
   ...
   public void holzFällerHütteAnnähern(){
       ...
       mainTextArea.setText("Du näherst dich der Hütte. Du stehst schon fast vor der Tür, da geht sie auf und ein Bärtiger großer Mann, mit einer Axt in der Hand, kommt hinaus.\nBärtiger Mann: Oh, habt ihr Euch verlaufen?  Ich wollte gerade etwas Feuerholz hacken.");
   ...
   public void holzFällerBaumFällen(){
       ...
       mainTextArea.setText("Gerne, ich bräuchte noch mehr Feuerholz. Könntest du hier im angrenzenden Wald noch etwas sammeln ?\n Ich wollte etwas zu essen machen, so könnte ich schon einmal anfangen. Du bist herzlich eingeladen mit uns zu essen.");
   ...
   public void neinDanke(){
       position = "neinDanke";
       mainTextArea.setText("Das ist aber schade.\n Auf wiedersehen.");
   ...
   public void holzFällerBäumeFällen(){
       ...
       mainTextArea.setText("Du gehst in den Wald und ein Goblin läuft dir über den Weg.\n Ihr schaut euch erschrocken an.");
   ...
   public void holzFällerEssen2(){
       ...
       mainTextArea.setText("Ihr seht wirklich erschöpft aus. \nGeht schon einmal ins Haus. Meine Frau bereitet schon einmal alles vor. Ruht euch etwas aus.");
   ...
   public void essenUndAusruhen(){
       ...
       mainTextArea.setText("Ihr ruht euch aus und esst etwas.\n\nIhr fühlt euch gut.\n\n\n(Du erhältst 5 Lebenspunkte.)");
       playerHP = playerHP + 5;
        hpLabelNumber.setText(""+playerHP);
       choice1.setText("Weggehen");
        choice2.setText("");
   ...
   public void holzFällerHütteBeobachten(){
       ...
       mainTextArea.setText("Du gehst neben dem Weg ins Gebüsch und schleicht den Weg weiter fort. \n\nDu siehst einen Mann, der gerade seine Hütte verlässt und Holz hackt.");
        choice1.setText("Annähern.");
   ...
   public void holzFällerMannAnnähern(){
       ...
       mainTextArea.setText("Oh grüßt euch. Ihr habt euch also doch aus eurem Versteck gewagt.\n\n Wie ich sehe, habt ihr nichts bösartiges vor.\n\n Möchtet Ihr euch ausruhen?");
   ...
   public void holzFällerMannBedrohen(){
       ...
       mainTextArea.setText("Du läufst zum Bärtigen Mann. \n\nEr hat euch schon längst bemerkt.\n Er Dreht sich um und schlägt dir mit einem Hieb den Kopf ab.\n\n\nDu bist gestorben!\n\n<GAME OVER>");
    ...
    public void taverne(){
        position = "taverne";
        mainTextArea.setText("Du betrittst die Taverne. Stickige und Tabak verrauchte Luft schlägt euch ins Gesicht. Viele Gäste hat die Taverne zum speckigen Schwein nicht. Zwei Trinker sitzen in der Ecke und spielen ein Würfelspiel. Weiter abseits sitzt ein weiterer Gast, der offensichtlich einen sehr großen Durst besitzt. \n\nDer Wirt kommt hinter der Theke her.\n Wirt: Guten Tag Fremder, mein Name ist Elfond. \n Er macht eine kleine verbeugung.\n Wirt: Wie kann ich Euch dienlich sein? Ihr seht sehr erschöpft aus. Möchtet Ihr ein Zimmer haben? Momentan sind sie Kostenlos zur vermietung. \n\nSie müssen nur rumerzählen, dass Ihnen hier nichts passiert ist.");
    ...
    public void taverneAusruhen(){
        ...
        mainTextArea.setText("\nElfond: Gerne, einfach die Treppe hoch. Sucht Euch ein Zimmer aus.\n\nDu schleppst dich die Treppen hoch. Die Stufen knarzen. Hier wurden lange Zeit nicht sauber gemacht. Spinnenweben zieren den Treppenaufgang. Oben angekommen erstreckt sich ein langer Korridor mit vier Türen. ");
    ...
    public void händlerHaus(){
        ...
        mainTextArea.setText("Du betrittst das Händlerhaus.\n\n Du befindest dich in einem großen Raum, welcher mit den verschiedensten Dingen vollgepackt ist. Wäre dein Goldsack nicht so leer, hättest du hier sicher etwas gefunden.\n\nEin großer schlanker Mann kommt hinter einem Stapel Kisten hervor.\nHändler: Seid gegrüßt fremder.\nHändler: Mein Name ist Egon, wie kann ich Euch helfen?");
    ...
    public void crossRoad(){
        position = "crossRoad";
        mainTextArea.setText("Du bist an der Kreuzung.\nWenn du nach Süden gehst, wirst du zurück zum\nDorf gehen.");
    ...
    public void kampfSpuren(){
        ...
        mainTextArea.setText("Als du dich näherst, siehst du einen Wagen am Wegesrand und zwei Pferde die auf dem Boden liegen. Sie haben wohl den Wagen gezogen. \nDie Pferde weisen deutliche Kampfspuren auf.\n Jemand hat ihnen mit einem Bogen Pfeile in den Kopf geschossen. Was dir auffällt ist, dass keine menschlichen Leichen zu sehen sind. Es sind aber deutliche schleifspuren in der matschigen Erde zu sehen. Die Spuren führen weiter in den Wald hinein.  ");
    ...
    public void talkGuard(){
        position = "talkGuard";
        mainTextArea.setText("Wache: Hallo Fremder. Dein \nGesicht habe ich hier noch nie \ngesehen. Was führt dich her?");
    ...
    public void antwortWacheHändler(){
        position = "antwortWache";
        mainTextArea.setText("Ah, sehr interessant.\n Ich empfehle Euch Egon zu besuchen. Er ist im Handelshaus und hat allerlei Kram zu verkaufen.");
        choice1.setText("In das Dorf gehen.");
        choice2.setText("Zur Kreuzung.");
        choice3.setText("");
        choice4.setText("");
    ...
    public void ichSeheMichNurUm(){
        ...
        mainTextArea.setText("Viele verschiedene Waren liegen hier herum.\n Aber leider hast du nicht genug Gold dafür.");
    ...
    public void winGeist(){
        position = "winGeist";
        mainTextArea.setText("Du hast das Monster besiegt!\n\n\n Ein lautes schreien ertönt und verstummt von einer Sekunde auf die andere. Der Teddybär fällt zu Boden und du hebst ihn auf.");
        teddybär = 1;
